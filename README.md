...
To use this flow you've to adjust the following 4 nodes:
- Login credentials: _provide your username and password you use to login to https://enlighten.enphaseenergy.com_
- Envoy address (2x): _ip address of your Enphase envoy iq gateway_
...
# How does it work
The flow has been divided in 4 blocks.
...
3. **Request token from Enphase**<br>This block consists out of 4 steps:
...
In the flow as it is documented here saves the token to memory. You can also decide to save the token to a file. Therefore you have to do the following:
...
4. **Decode JWT token**<br>This will let you decode the token to see expirationDate, createdAt and more.
